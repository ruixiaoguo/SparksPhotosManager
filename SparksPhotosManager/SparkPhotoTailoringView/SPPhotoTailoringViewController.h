...
@class SPPhotoTailoringViewController;

@protocol PhotoViewControllerDelegate <NSObject>

- (void)imageCropper:(SPPhotoTailoringViewController *)cropperViewController
         didFinished:(UIImage *)editedImage;
- (void)imageCropperDidCancel:(SPPhotoTailoringViewController *)cropperViewController;

@end

@interface SPPhotoTailoringViewController : UIViewController
