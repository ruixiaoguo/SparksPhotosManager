...
#import "SPPhotoMaskView.h"
#import "UIImage+Crop.h"

@interface SPPhotoTailoringViewController ()<UIScrollViewDelegate,PhotoMaskViewDelegate>
{
    CGRect            _rect;
...
@property (nonatomic,strong) SPPhotoMaskView *maskView;
@property (nonatomic,strong) UIScrollView *scrollView;
@property (nonatomic,strong) UIButton *btn;

@end

@implementation SPPhotoTailoringViewController
...
- (void)viewDidLoad
{
    ...
    _maskView = [[SPPhotoMaskView alloc] initWithFrame:self.view.bounds width:width height:height];
...
-(void)bottomView
{
    ...
    [cancelBtn setTitle:@"Cancle" forState:UIControlStateNormal];
